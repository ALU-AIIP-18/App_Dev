...
@author: rbisa
"""
#import libraries and __init__.py file
...
solar_data = pd.read_csv(r'C:\Users\rbisa\anaconda3\envs\appdevenv\App_Dev\solar_generation_data.csv')
...
dataset = solar_data_2.drop(['Month', 'Day', 'Date', 'Year', 'PowerGeneratedinMW','Rainfallinmm'], axis=1)
X = dataset.values
...
#pickling
#with open(r"C:\Users\rbisa\anaconda3\envs\appdevenv\App_Dev_Summative\model.pkl", 'wb') as file_out:
#    pickle.dump(forest_model, file_out)
#    file_out.close()
